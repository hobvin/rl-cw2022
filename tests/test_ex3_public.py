...
def test_imports_0():
    ...
    from rl2022.exercise3.train_dqn import LUNARLANDER_CONFIG as DQN_LUNARLANDER_CONFIG

    from rl2022.exercise3.train_reinforce import CARTPOLE_CONFIG as REINF_CARTPOLE_CONFIG
    #~ from rl2022.exercise3.train_reinforce import LUNARLANDER_CONFIG as REINF_LUNARLANDER_CONFIG


def test_config_0():
    from rl2022.exercise3.train_dqn import CARTPOLE_CONFIG
...
def test_config_1():
    from rl2022.exercise3.train_dqn import LUNARLANDER_CONFIG
...
#~ def test_config_3():
    #~ from rl2022.exercise3.train_reinforce import LUNARLANDER_CONFIG
    #~ assert "eval_freq" in LUNARLANDER_CONFIG
    #~ assert "eval_episodes" in LUNARLANDER_CONFIG
    #~ assert "episode_length" in LUNARLANDER_CONFIG
    #~ assert "max_timesteps" in LUNARLANDER_CONFIG
...
def test_restore_file_0():
    from rl2022.exercise3 import DQN
    from rl2022.exercise3.train_dqn import LUNARLANDER_CONFIG as DQN_LUNARLANDER_CONFIG
